...
```{r, fig.width = 8.5, fig.height = 5, fig.cap="trayectoria y desplazamiento cuadrado", dev='svg'}
...
```{r, fig.width = 6, fig.height = 5, fig.cap="Desplazamiento cuadrado observado (línea con puntos) y simulado (líneas grises). Las líneas sólidas marcan los percentiles de 95%.", dev='svg'}
