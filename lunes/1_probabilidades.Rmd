...
````{r, fig.width = 4, fig.height = 4, fig.cap= paste("Histograma de datos simulados de una Poisson con $\\lambda =$", lambda)}
...
```{r, fig.width = 4, fig.height = 4, fig.cap=paste("Distribución empírica y teórica para Poisson con $\\lambda =$", lambda)}
...
```{r, fig.width = 4, fig.height = 4, fig.cap=paste("Acumulada empírica y teórica para Poisson con $\\lambda =$", lambda)}
eF <- ecdf(y)
...
```{r, fig.width = 4, fig.height = 4, fig.cap = paste("Histograma de datos simulados, densidad empírica (en negro) y teórica (en rojo) de una distribución Normal con $\\mu=$", mu, "y $\\sigma=$", sigma)}
...
```{r, fig.width = 8, fig.height = 4, fig.cap="trayectoria y desplazamiento cuadrado"}
setwd("~/Dropbox/ME")
...
```{r, fig.width = 6, fig.height = 4, fig.cap="Desplazamiento cuadrado observado (línea con puntos) y simulado (líneas grises). Las líneas sólidas marcan los percentiles de 95%."}
