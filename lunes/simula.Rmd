...
```{r, fig.width = 7, fig.height = 4, fig.cap="Desplazamiento cuadrado observado (línea con puntos) y simulado (líneas grises). Las líneas sólidas marcan los percentiles de 95%."}
