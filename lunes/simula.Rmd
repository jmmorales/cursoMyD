...
````{r, fig.width = 5, fig.height = 5, fig.cap= paste("Histograma de datos simulados de una Poisson con $\\lambda =$", lambda)}
...
```{r, fig.width = 5, fig.height = 5, fig.cap=paste("Distribución empírica y teórica para Poisson con $\\lambda =$", lambda)}
...
```{r, fig.width = 5, fig.height = 5, fig.cap=paste("Acumulada empírica y teórica para Poisson con $\\lambda =$", lambda)}
eF <- ecdf(y)
...
```{r, fig.width = 5, fig.height = 5, fig.cap = paste("Histograma de datos simulados, densidad empírica (en negro) y teórica (en rojo) de una distribución Normal con $\\mu=$", mu, "y $\\sigma=$", sigma)}
