...
plot(theta, nLL2, type = "l",xlab=expression(theta), ylab="-logL", main="n=2", ylim=c(0,100))
plot(theta, nLL10, type = "l",xlab=expression(theta), ylab="-logL", main="n=10", ylim=c(0,100))
par(op)
```
