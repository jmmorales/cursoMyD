...
Empecemos con una regresión lineal normal. En este caso el modelo es:
...
Una buena práctica cuando hacemos regresiones de este tipo es centrar y estandarizar las variables predictoras:
...
2- Reemplazar la función lineal por una Holling tipo II y usar una Poisson para la parte estocástica del modelo.

3- Simular y ajustar con mle2 un modelo de dinámica poblacional estocástico (exponencial y en tiempo discreto)
